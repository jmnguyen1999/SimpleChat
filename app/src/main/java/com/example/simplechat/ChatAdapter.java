...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.MessageViewHolder> {
    ...
    public class IncomingMessageViewHolder extends ChatAdapter.MessageViewHolder {
    ...
    public class OutgoingMessageViewHolder extends ChatAdapter.MessageViewHolder {
        ImageView imageMe;
        TextView body;
